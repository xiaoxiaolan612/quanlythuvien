            ...
            <tr class="rem1">
                ...
                <td class="invert-image">
                    <a href="single_product.html">
                        <img src={ props.borrow.book.bookImage } alt=" " class="img-responsive" />
                    </a>
                </td>

                <td class="invert">{ props.borrow.book.bookName }</td>
                <td class="invert">{ props.borrow.book.bookAuthor }</td>
                <td class="invert">{ props.borrow.book.category.categoryName }</td>
                <td class="invert">{ props.borrow.book.publisher }</td>
